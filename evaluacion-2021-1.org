...
11. Podrán agregarse actividades  o tareas a lo largo del semestre, revisa  esta página una vez a
    la semana.

# 7. Selecciona de la siguiente lista una noticia.  Haz una presentación centrada en la noticia y
#   empleando el método dialéctico. Graba un video exponiendo la noticia. (2P c/u)

#    - https://actualidad.rt.com/actualidad/376020-chavismo-lidera-elecciones-parlamentarias-venezuela
