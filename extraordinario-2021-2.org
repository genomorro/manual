...
1. El examen  tendrá lugar el 2  de julio de 2021  en un horario de  13:00 a 15:00 y  de 17:00 a
   19:00. Verifica el horario con anticipación dentro de la plataforma.
...
3. La  forma de  entrar al  sitio será  con un  nombre de  usuario y  contraseña, los  cuales se
   ...
   - Contraseña:
     ...
     |      N.C. | Contraseña  |
     |-----------+-------------|
     | 312092388 | 7Bbw8UnCVIk |
     | 306314298 | Tuwjgcl7YEI |
     | 318023320 | kkz8iKVVdQg |
     | 318187505 | gO5x8L3jYKo |
     | 315280085 | Hi9Uou0zWw8 |
     | 317263550 | iJupDUq8ME8 |
     | 318157245 | gkuZpm7RlQ0 |
     | 316310077 | CpyLfM3gqOE |
     | 316134163 | kq71H4xDPIM |
     | 315121496 | Wy5fRWlGNG4 |
...
2. Debido a que el  alumno no tendrá supervisión a la hora del examen,  el único control a tener
   ...
   comenzar el examen en  cualquier minuto a partir de la hora de  inicio, el sistema se cerrará
   automáticamente a  la hora señalada.  Todo examen está programado  para ser suspendido  a las
   15:00 y 19:00 según corresponda, sin excepción.
3.  El  sistema califica  de  forma  automática el  examen,  sin  embargo, el  sinodal  revisará
   ...
   anómala.
4. Al  final del examen  el sistema mostrará  tu calificación automática  en un rango  de [0,1],
   pudes multiplicar por  diez ese resultado para  obtener un número más claro,  por ejemplo: un
   resultado de 0.8 será igual a un 8 de calificación en el examen.
5.     La calificación  del examen  estará disponible  en el  expediente del  alumno tan  pronto
